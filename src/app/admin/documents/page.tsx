  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/admin/documents/new" className="flex items-center gap-2 px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600">
      ...
      <div className="bg-white rounded-lg shadow">
        {loading ? (
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-gray-500 mb-6">Добавьте сертификаты и документы</p>
            <Link href="/admin/documents/new" className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600">
              <Plus className="w-4 h-4" />
              Добавить документ
            </Link>
          </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                ...
                <th className="text-left px-4 py-3 text-sm font-medium text-gray-600">Кем выдан</th>
              ...
              {items.map((item) => (
                <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-sm">
                    <span className="px-2 py-1 bg-gray-100 rounded text-xs">{getTypeLabel(item.type)}</span>
                  </td>
                  <td className="px-4 py-3 text-sm text-gray-500">{item.issuer || '—'}</td>
                  ...
                  <td className="px-4 py-3 text-right">
                    <Link href={`/admin/documents/${item.id}`} className="p-2 text-gray-500 hover:text-orange-500">
