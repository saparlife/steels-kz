    ...
    questions: [
      {
        ...
        a: 'Оформить заказ можно несколькими способами: позвонить по телефону +7 (7273) 123-291, отправить заявку через форму на сайте, написать на email info@steels.kz или обратиться в WhatsApp. Наш менеджер свяжется с вами для уточнения деталей и расчета стоимости.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Да, самовывоз возможен с нашего склада в рабочие дни с 9:00 до 18:00, в субботу с 9:00 до 15:00. Адрес: г. Алматы, ул. Примерная, 1.',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Актуальное наличие можно уточнить у менеджера по телефону +7 (7273) 123-291 или отправив запрос на email. Информация на сайте обновляется ежедневно.',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Да, отправьте запрос с перечнем необходимой продукции на email info@steels.kz, и мы подготовим коммерческое предложение в течение 1-2 часов.',
      },
    ],
  },
]
