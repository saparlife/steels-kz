    ...
    questions: [
      {
        ...
        a: 'Оформить заказ можно несколькими способами: позвонить по телефону +7 (700) 161-87-67, отправить заявку через форму на сайте, написать на email sale@temirservice.kz или обратиться в WhatsApp. Наш менеджер свяжется с вами для уточнения деталей и расчета стоимости.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Да, отправьте запрос с перечнем необходимой продукции на email sale@temirservice.kz, и мы подготовим коммерческое предложение в течение 1-2 часов.',
      },
    ],
  },
]
